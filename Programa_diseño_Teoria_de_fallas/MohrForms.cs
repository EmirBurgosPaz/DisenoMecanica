...
{
    public partial class MohrForms : Form
    {
        DataFailureMohr data = new DataFailureMohr();
        Graphics graphics;
        Pen Axis;
            ...
            else
            {
                ...
                if (data.ValorEsfuerzoCortante == 0)
                {
                    ...
                    if (data.ValorEsfuerzoX > 0 && data.ValorEsfuerzoY < 0)
                    {
                        ...
                        AnsNFactor.Text = "" + data.FactorSeguridadN4(data.ValorEsfuerzoX, data.ValorEsfuerzoY
                    ...
                    else if (data.ValorEsfuerzoX > 0 && data.ValorEsfuerzoY > 0)
                    {
                        ...
                        AnsNFactor.Text = "" + data.FactorseguridadN1(data.ValorEsfuerzoX
                                                                   , data.ValorResTens);
                        todos = data.ValorEsfuerzoX + " , " + data.ValorEsfuerzoY;
                        EsfuerzosXY.Items.Add(new ListViewItem(todos, Mostrar));
                    }
                    else if (data.ValorEsfuerzoX < 0 && data.ValorEsfuerzoY < 0)
                    {
                        ...
                        AnsNFactor.Text = "" + data.FactorseguridadN3( data.ValorEsfuerzoY
                                                                   , data.ValorResComp);
                        todos = data.ValorEsfuerzoX + " , " + data.ValorEsfuerzoY;
                        EsfuerzosXY.Items.Add(new ListViewItem(todos, Mostrar));
                    }
                ...
                else
                {
                    ...
                    if (data.ValorEsfuerzoXCor > 0 && data.ValorEsfuerzoYCor < 0)
                    {
                        ...
                        AnsNFactor.Text = "" + data.FactorSeguridadN4(data.ValorEsfuerzoXCor, data.ValorEsfuerzoYCor
                                            , data.ValorResComp, data.ValorResTens);
                    ...
                    else if (data.ValorEsfuerzoXCor > 0 && data.ValorEsfuerzoYCor > 0)
                    {
                        ...
                        AnsNFactor.Text = "" + data.FactorseguridadN1(data.ValorEsfuerzoXCor
                                                                   , data.ValorResTens);
                        todos = data.ValorEsfuerzoXCor + " , " + data.ValorEsfuerzoYCor;
                        EsfuerzosXY.Items.Add(new ListViewItem(todos, Mostrar));
                    }
                    else if (data.ValorEsfuerzoXCor < 0 && data.ValorEsfuerzoYCor < 0)
                    {
                        ...
                        AnsNFactor.Text = "" + data.FactorseguridadN3(data.ValorEsfuerzoYCor
                                                                   , data.ValorResComp);
                        todos = data.ValorEsfuerzoXCor + " , " + data.ValorEsfuerzoYCor;
                        EsfuerzosXY.Items.Add(new ListViewItem(todos, Mostrar));
