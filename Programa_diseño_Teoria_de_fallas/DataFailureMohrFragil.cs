...
namespace Programa_diseño_Teoria_de_fallas
{
    class DataFailureMohrFragil
    {
        ...
        public double FactorSeguridadN4MM(double valorEsfuerzoX, double valorEsfuerzoY, double valorResComp, double valorResTens)
        {
            Double parteA1 = valorResComp - valorResTens;
            Double parteA2 = valorResComp * valorResTens;
            Double parteA = (parteA1 * valorEsfuerzoX) / parteA2;
            Double parteB = valorEsfuerzoY / valorResComp;
            Double valor = Math.Abs(Math.Round(1 / (parteA - parteB), 3));
            return valor;
        }

        public Double CasoMedio(double valorEsfuerzoX, double valorEsfuerzoY)
        {
            Double valor = (valorEsfuerzoY / valorEsfuerzoX);
