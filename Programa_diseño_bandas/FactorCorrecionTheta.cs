...
{
    public partial class FactorCorrecionTheta : Form
    {
        public FactorCorrecionTheta(Double AnguloCorreccionTheta)
        {
            InitializeComponent();
            KeepTheta1.Text = "Angulo Theta es:" + Math.Round(AnguloCorreccionTheta, 3);
