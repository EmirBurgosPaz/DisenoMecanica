...
{
    public partial class _5vDiameter : Form
    {
        public Double InitialRPM;
        public Double FinalRPM;
        public Double RelationDiameter;
        public _5vDiameter(Double valorFinalRPM, Double valorInicialRPM, Double valorDimaterRelations)
        {
            InitializeComponent();
        ...
        public double[] RDIterada = new double[15];
        ...
        public double[] DiameterStandar = { 7.00, 7.40, 7.90,8.40, 8.90,9.15 ,9.65, 10.20
                        ,10.80, 11.70, 12.40, 13.10, 13.90, 14.90, 15.90 };

        public double[] DiameterStandar2 = { 21.1, 27.7, 37.4,49.9 };
                ...
                for (int i = 0; i < DiameterStandar2.Length; i++)
                {
                    for (int v = 0; v < DiameterStandar.Length; v++)
                    {
                        ...
                        if (VelIterada[i] > FinalRPM)
                        {
                            ...
                            if (RDIterada[i] == 0)
                            {
                                Dtervals[i] = DiameterStandar[14] / DiameterStandar2[3];
                                D1Select[i] = DiameterStandar[14];
